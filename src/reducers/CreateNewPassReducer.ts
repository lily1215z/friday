...
export const CreateNewPassReducer = (state: any = initialState, action: createNewPassActionType): any => {
    switch (action.type) {
        case TEST:
            return state;
...
//type
export type createNewPassActionType = ReturnType<typeof testAC>