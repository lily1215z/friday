...
export const FogotPassCheckEmailReducer = (state: any = initialState, action: fogotPassCheckEmailActionType): any => {
    switch (action.type) {
        case TEST:
            return state;
...
//type
export type fogotPassCheckEmailActionType = ReturnType<typeof testAC>